    ...
    return [
        {
            ...
            items: [
                { type: 'label', text: 'Select AI model for execution' },
                {
                    ...
                    key: 'model',
                    label: 'Model',
                    options: settings_1.AVAILABLE_MODELS,
        ...
        },
        {
            name: 'UI',
            items: [
                { type: 'toggle', key: 'asciiLogo', label: 'ASCII Logo', values: ['on', 'off'], getValue: (s) => s.ui.asciiLogo, setValue: (s, v) => { s.ui.asciiLogo = v; } },
                { type: 'toggle', key: 'color', label: 'Color Output', values: ['auto', 'on', 'off'], getValue: (s) => s.ui.color, setValue: (s, v) => { s.ui.color = v; } },
                { type: 'toggle', key: 'promptStyle', label: 'Prompt Style', values: ['compact', 'verbose'], getValue: (s) => s.ui.promptStyle, setValue: (s, v) => { s.ui.promptStyle = v; } },
            ],
        },
        {
            name: 'Execution',
            items: [
                { type: 'toggle', key: 'confirmationMode', label: 'Confirmation', values: ['strict', 'normal'], getValue: (s) => s.execution.confirmationMode, setValue: (s, v) => { s.execution.confirmationMode = v; } },
        ...
        },
        {
            name: 'Context',
            items: [
                { type: 'toggle', key: 'scope', label: 'Scope', values: ['open', 'touched', 'full'], getValue: (s) => s.context.scope, setValue: (s, v) => { s.context.scope = v; } },
        ...
        },
        {
            ...
            items: [
                ...
                { type: 'toggle', key: 'errorDetail', label: 'Error Detail', values: ['brief', 'full'], getValue: (s) => s.debug.errorDetail, setValue: (s, v) => { s.debug.errorDetail = v; } },
...
// Render the menu
function render(sections, sectionIndex, itemIndex, settings, warning) {
    clearScreen();
...
async function openSettingsMenu() {
    ...
    const originalSettings = JSON.parse(JSON.stringify((0, settings_1.loadSettings)()));
...
//# sourceMappingURL=settings_menu.js.map